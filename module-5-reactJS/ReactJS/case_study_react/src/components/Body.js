                                            ...
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="room-type"><a
                                                        href="https://furamavietnam.com/vi/rooms/ocean-suite/">PHÒNG
                                                        SUITE HƯỚNG BIỂN</a></h3>
                                                </div>
                                    ...
                                    <div className="room-card">
                                        ...
                                        <div className="room-card-info">
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="room-type"><a
                                                        href="https://furamavietnam.com/vi/rooms/ocean-studio-suite/">PHÒNG
                                                        STUDIO SUITE HƯỚNG BIỂN</a></h3>
                                                </div>
                                                <div className="col-auto ml-auto">
                                                    <div className="room-card-attr">
                                            <span data-toggle="popover" data-trigger="hover" data-placement="top"
                                    ...
                                    <div className="room-card">
                                        ...
                                        <div className="room-card-info">
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="room-type"><a
                                                        href="https://furamavietnam.com/vi/rooms/ocean-deluxe/">PHÒNG
                                                        DELUXE
                                                        HƯỚNG BIỂN</a></h3>
                                                </div>
                                                <div className="col-auto ml-auto">
                                    ...
                                    <div className="room-card">
                                        <div className="room-card-photo">
                                            <img width="370" height="239"
                                                 ...
                                                 className="img-fluid wp-post-image" alt=""
                                                 srcSet="https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F-370x239.jpg 370w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F-300x194.jpg 300w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F-768x497.jpg 768w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F-871x563.jpg 871w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F-145x94.jpg 145w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F.jpg 900w"
                                                 sizes="(max-width: 370px) 100vw, 370px"></img>
                                        ...
                                        <div className="room-card-info">
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="room-type"><a
                                                        href="https://furamavietnam.com/vi/rooms/lagoon-superior/">PHÒNG
                                                        SUPERIOR HƯỚNG HỒ</a></h3>
                                                </div>
                                                <div className="col-auto ml-auto">
                                                    <div className="room-card-attr">
                                            <span data-toggle="popover" data-trigger="hover" data-placement="top"
                                    ...
                                    <div className="room-card">
                                        <div className="room-card-photo">
                                            <img width="370" height="239"
                                                 ...
                                                 className="img-fluid wp-post-image" alt=""
                                                 srcSet="https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Garden-Superior-TwinBed-1-F-370x239.jpg 370w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Garden-Superior-TwinBed-1-F-300x194.jpg 300w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Garden-Superior-TwinBed-1-F-768x497.jpg 768w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Garden-Superior-TwinBed-1-F-871x563.jpg 871w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Garden-Superior-TwinBed-1-F-145x94.jpg 145w, https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Garden-Superior-TwinBed-1-F.jpg 900w"
                                                 sizes="(max-width: 370px) 100vw, 370px"></img>
                                        </div>
                                        <div className="room-card-info">
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="room-type"><a
                                                        href="https://furamavietnam.com/vi/rooms/garden-superior/">PHÒNG
                                                        SUPERIOR HƯỚNG VƯỜN</a></h3>
                                                </div>
                                                <div className="col-auto ml-auto">
                                                    <div className="room-card-attr">
                                            <span data-toggle="popover" data-trigger="hover" data-placement="top"
                                                  data-content="2 Guests" data-original-title="" title=""><i
                                                className="icon-two-man"></i></span>
                                                        <span data-toggle="popover" data-trigger="hover"
                                                              data-placement="top"
                                                              data-content="Double/Twin" data-original-title=""
                                                              title=""><i
                                                            className="icon-double-size-bed"></i></span>
                                                        <span data-toggle="popover" data-trigger="hover"
                                                              data-placement="top"
                                                              data-content="Separate" data-original-title="" title=""><i
                                                            className="icon-bathtub"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="room-card">
                                        <div className="room-card-photo">
                                            <img width="370" height="239"
                                                 ...
                                                 className="img-fluid wp-post-image" alt=""
                                                 srcSet="https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-370x239.jpg 370w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-300x194.jpg 300w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-768x496.jpg 768w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-1024x661.jpg 1024w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-450x291.jpg 450w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-872x563.jpg 872w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5-145x94.jpg 145w, https://furamavietnam.com/wp-content/uploads/2018/03/Furama_Garden-Deluxe-5.jpg 1542w"
                                                 sizes="(max-width: 370px) 100vw, 370px"></img>
                                        </div>
                                        <div className="room-card-info">
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="room-type"><a
                                                        href="https://furamavietnam.com/vi/rooms/garden-deluxe/">PHÒNG
                                                        DELUXE
                                                        HƯỚNG VƯỜN</a></h3>
                                                </div>
                                                <div className="col-auto ml-auto">
